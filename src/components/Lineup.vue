...
const bands = [
  { 
   ...
   { 
    ...
    about: 'Zip adalah band hardcore asal Jakarta yang dikenal dengan sound cepat, padat, dan penuh energi, terinspirasi dari gaya NYHC / youth crew. Musik mereka straight to the point dengan riff agresif, bagian singalong, serta nuansa kebersamaan yang kuat. Liriknya banyak mengangkat tema persaudaraan, scene, dan sikap hidup, menjadikan Zip sebagai salah satu representasi solid dari semangat hardcore di Jakarta.',
    social: '@ZIP_hxc',
    // spotifyLink: 'https://open.spotify.com/embed/artist/5lU30M9td0FUDVSTCucwnu?utm_source=generator&theme=0',
   ...
   { 
    ...
    about: 'The End adalah band Oi!/punk asal Jakarta yang lekat dengan attitude skinhead klasik—simple, keras, dan penuh semangat jalanan. Musik mereka menggabungkan energi punk dengan sentuhan Oi! yang kental, menghadirkan chorus yang mudah diikuti dan vibe pogo yang kuat. Dengan image khas seperti suspender dan boots, The End membawa nuansa kebersamaan, loyalitas, dan pride skena, menjadikannya salah satu nama yang punya karakter solid di ranah street punk Jakarta.',
    social: '@theend_hxc',
    // spotifyLink: 'https://open.spotify.com/embed/artist/5lU30M9td0FUDVSTCucwnu?utm_source=generator&theme=0',
    // appleMusicLink: 'https://music.apple.com/us/artist/haywire-617/1715695747',
  ...
  { 
    ...
    about: 'Karmax adalah band hardcore asal Jakarta yang membawa sound raw dan old-school, terinspirasi dari band-band seperti Cro-Mags, Bad Brains, dan Discharge. Musik mereka cepat, agresif, dan tanpa basa-basi, dengan lagu-lagu yang langsung menghantam. Secara lirik, Karmax banyak mengangkat tema frustrasi, kehidupan sehari-hari, dan kerasnya hidup di kota, dibalut dengan semangat spritual namun masih sangat hardcore.',
    social: '@karmx_hxc',
    // spotifyLink: 'https://open.spotify.com/embed/artist/5lU30M9td0FUDVSTCucwnu?utm_source=generator&theme=0',
